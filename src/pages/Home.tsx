    ...
    <div className="flex-1 flex flex-col items-center">
      ...
      <section className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-32 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
          <Link
            to="/generate"
            className="flex items-center px-8 py-4 bg-sky-500 text-white rounded-full font-medium text-lg hover:bg-sky-600 transition-colors shadow-sm"
          >
      ...
      {/* Features Section */}
      <section id="features" className="w-full bg-sky-50/50 py-24">
